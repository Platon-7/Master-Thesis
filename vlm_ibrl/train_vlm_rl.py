...
from env.robosuite_vlm_env import VLMRobosuite
...
class MainConfig(common_utils.RunConfig):
    ...
    use_wb: int = 1
    wb_exp: str = 'IBRL_RoboMimic'
    wb_run_name: str = 'test'
...
class Workspace:
    ...
    def _setup_env(self):
        ...
        all_cameras = self.rl_cameras + ["agentview"]

        self.train_env = VLMRobosuite(
            ...
            end_on_success=bool(self.cfg.train_end_on_success),
