...
class Workspace:
    ...
    def _setup_env(self):
        ...
        self.env_params["too_early_reward"] = bool(self.cfg.too_early_reward)
        self.env_params["reward_at_truncation"] = self.cfg.reward_at_truncation
        ...
        eval_env_params["too_early_reward"] = False
        self.env_params["reward_at_truncation"] = False
