...
class ProgressSample(BaseModel):
    ...
    # Optional successful demonstration prepended as in-context example. Populated by the sampler when
    # data.use_icl=True and a per-sample Bernoulli(data.icl_prob) fires. None = ICL off for this sample.
    context_trajectory: Optional[Trajectory] = None
