...
FIG = Path("/gpfs/home3/pkarageorgis1/Master-Thesis/post-training-analysis/reward-model-study/figures")
RES = Path("/gpfs/home3/pkarageorgis1/Master-Thesis/post-training-analysis/reward-model-study/results")
