...
def collect(task, key):
    ...
    agg={}
    for d in sorted(glob.glob(f"{RD}/iclon_run1_icl_ours_step4000_{task}_gate_*_812_*")):
...
fig.suptitle("≥1 demo: run1 + ICL + gate  ·  3 seeds", fontsize=12.5)
fig.tight_layout()
out="/shared/home/PKA4388/Master-Thesis/post-training-analysis/reward-model-study/deck/fig_versionA_run1gate.png"
