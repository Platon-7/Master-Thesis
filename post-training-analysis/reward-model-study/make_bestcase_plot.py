...
for col,(task,tlabel) in enumerate([("coffeepush","Coffee-Push"),("boxclose","Box-Close")]):
    ...
    ax.plot(xs,mean,color=GREEN,lw=2.6,label="GT success (mean of 6 seeds)")
...
fig.suptitle("Gate + offline-calibrated threshold  ·  run2  ·  6 seeds", fontsize=12.5)
fig.tight_layout()
out="/shared/home/PKA4388/Master-Thesis/post-training-analysis/reward-model-study/deck/fig_bestcase_run2.png"
