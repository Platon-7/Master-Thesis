...
set -u
LOG="/gpfs/home4/pkarageorgis/DAS-5/Master-Thesis/post-training-analysis/Robometer-LoRA/rclone_restore_frame_dataset.log"
WLOG="/gpfs/home4/pkarageorgis/DAS-5/Master-Thesis/post-training-analysis/Robometer-LoRA/watchdog.log"
...
cd /gpfs/home4/pkarageorgis/DAS-5/Master-Thesis/post-training-analysis/Robometer-LoRA || { log "cd to Robometer-LoRA failed"; exit 1; }
