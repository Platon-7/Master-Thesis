# Copied verbatim from vlm_ibrl/env/ (MetaWorld/Robomimic stack) so the ManiSkill
# stack can score the same baselines. Pure stdlib + torch + PIL, no vlm_ibrl coupling.
