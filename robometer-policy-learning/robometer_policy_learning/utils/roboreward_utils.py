# Copied from vlm_ibrl/env/ so the ManiSkill stack can load the RoboReward baseline.
# The ManiSkill loader (robometer.utils.save.load_model_from_hf) expects a
# Robometer-style config.yaml in the repo, which teetone/RoboReward-* does not
# have -- it 404s. That is why model_type "roboreward" existed in config but had
