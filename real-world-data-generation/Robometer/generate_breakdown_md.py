...
Output:
  --output  /gpfs/home3/pkarageorgis1/Master-Thesis/real-world-data-generation/Robometer/ROBOMETER_BREAKDOWN.md
...
def build_md(audit: dict, pairs: dict) -> str:
    ...
    lines.append("    --output /gpfs/home3/pkarageorgis1/Master-Thesis/real-world-data-generation/Robometer/ROBOMETER_BREAKDOWN.md")
    lines.append("```")
    lines.append("")
