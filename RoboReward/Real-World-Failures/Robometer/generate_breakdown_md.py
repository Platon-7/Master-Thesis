...
Output:
  --output  /gpfs/home3/pkarageorgis1/Master-Thesis/RoboReward/Real-World-Failures/Robometer/ROBOMETER_BREAKDOWN.md
...
def build_md(audit: dict, pairs: dict) -> str:
    ...
    lines.append("    --output /gpfs/home3/pkarageorgis1/Master-Thesis/RoboReward/Real-World-Failures/Robometer/ROBOMETER_BREAKDOWN.md")
    lines.append("```")
    lines.append("")
